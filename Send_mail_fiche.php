...
session_start();
 ...
 file_put_contents("log.txt",$toc. " ; "  .$_SESSION['user']. " ; " .date("[j/m/y H:i:s]")."  ; Envoie Fiche identite incident par Mail   \r\n".file_get_contents("log.txt"));
...
$cr20 =$bdd ->prepare('UPDATE incident SET check2=0  WHERE Toc=:tc');
$cr20 ->execute(array(
'tc'=> $toc ));
$cr20 ->closeCursor();
...
require "phpmailer/class.phpmailer.php"; 
			...
			$mail->AddAddress('Layth.Jaber@orange.com');
				//$mail->AddAddress('FII@orange.com');
