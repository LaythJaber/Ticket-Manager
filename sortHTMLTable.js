...
sortHTMLTable.prototype = {
    ...
    initialize: function( tableId, options ) {
        ...
        this.options = {
            reorderCol: false,
            pathToImgUp: '../../images/fleche_haut.png',
            pathToImgDown: '../../images/fleche_bas.png',
            pathToImgUpActive: '../../images/fleche_haut_active.png', // ajout vb1 : pour garder le dernier sens de tri activé
            pathToImgDownActive: '../../images/fleche_bas_active.png' // ajout vb1
        }.extend( options || {} );
